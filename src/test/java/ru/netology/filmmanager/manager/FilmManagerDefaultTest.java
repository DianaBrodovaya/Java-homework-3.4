...
public class FilmManagerDefaultTest {
    ...
    @Test
    public void shouldGetLastTenWithLessThenTenFilms() {
        filmManager.addFilm(film1);
        filmManager.addFilm(film2);
        filmManager.addFilm(film3);
    ...
    @Test
    public void shouldGetLastTenWithMoreThenTenFilms() {
        filmManager.addFilm(film1);
        filmManager.addFilm(film2);
        filmManager.addFilm(film3);
        filmManager.addFilm(film4);
        ...
        Film[] expected = new Film[]{film16, film15, film14, film13, film12, film11, film10, film9, film8, film7};
        assertArrayEquals(expected, filmManager.getLast());
    }

    @Test
    public void shouldGetLastTenWithTenFilms() {
        filmManager.addFilm(film1);
        filmManager.addFilm(film2);
        filmManager.addFilm(film3);
        filmManager.addFilm(film4);
    ...
    @Test
    public void shouldGetLastTenWithZeroFilms() {
